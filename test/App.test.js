...
describe('Clase Appointment', () => {
    ...
    const id_close = () => app.giveAppointment('Juan',day,'22:00',services[0]);
    ...
    test('Dinero ganado con las citas', () => {
        let money = Appointment.getMoneyCollected();
        expect(money).toBe(8)
        let appointmentGiven = () => app.giveAppointment('Pepe',day,'19:00',services[0]);
        appointmentGiven()
